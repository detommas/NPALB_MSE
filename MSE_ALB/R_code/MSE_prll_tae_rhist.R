...
pr = c(0.8,rep(0.9,7),0.8,rep(0.9,7))
  ...
  foreach(itr = 1:1, .packages = c('r4ss','Rcpp','dplyr','reshape2'),.noexport = "ssf2_V2.cpp") %dopar% { NPALB_MSE2_hs3_tvry_tae_rhist(hsnum,hcrnum,scnnum,itr, rdev1 = -4.35459e-06, Bthr = Bthr, Blim = Blim,Tmin=Tmin, pl = pl) }
