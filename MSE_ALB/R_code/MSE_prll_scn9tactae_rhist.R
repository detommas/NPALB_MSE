...
pr = c(0.8,rep(0.9,7),0.8,rep(0.9,7))
  ...
  #Blim is the limit reference point representing the fraction of unfished dynamic SSB
  ...
  foreach(itr = 1:1, .packages = c('r4ss','Rcpp','dplyr','reshape2'),.noexport = "ssf2_V2.cpp") %dopar% { NPALB_MSE2_hs3_tvry_scn9tactae_rhist(hsnum,hcrnum,scnnum,itr, rdev1 = -4.35459e-06, Bthr = Bthr, Blim = Blim,Tmin=Tmin, pl = pl)}
