...
HCR3_TAC2_tactae_rhist <- function(myreplist,dat, datom, yr, yrom, SSBtrs, SSBlim, Ftgt,TACmin,TACmax,plim,err,cr,pdir, sdir, hs, hcr, scn, hsw, hcrw, scnw, pwin, itr, tstep,hcrnum){
