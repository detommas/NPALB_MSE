...
#' @param TAcmax is the maximum historical catch not be exceeded by the TAC
...
HCR3_TAC2 <- function(myreplist,dat, yr, SSBtrs, SSBlim, Ftgt,TACmin,TACmax,plim){
  ...
  d4 = get_maa(myreplist)    #Get maturity at age
