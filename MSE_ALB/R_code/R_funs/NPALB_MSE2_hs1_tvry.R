...
NPALB_MSE2_hs1_tvry = function(hsnum,hcrnum,scnnum,itr, rdev1, Bthr, Blim) { 
...
pdir = "C:/Users/Desiree.Tommasi/Desktop/For_Nathan/MSE_ALB/"
pwin = "C:\\Users\\Desiree.Tommasi\\Desktop\\For_Nathan\\MSE_ALB\\"

#Specify the path of conditioned initial OM
sdir = "C:/Users/Desiree.Tommasi/Desktop/For_Nathan/MSE_ALB/Condition/"
...
imp_e = implem_bierr(itr, n=30, nf=10, sigma=0.05)
...
for (tstep in 1:10){
  ...
  #*****************************************************************************************
  #Step 4: Run the estimation model using the data with error
  ...
  TAC_mat = HCR1_TAC_byfleet(dat = SPRmat, yr=yr_end, SSBtrs=ssb_thr, SSBlim=ssb_lim, Ftgt=em_ftgt, cr=cr_c, err=imp_e[tstep,])
