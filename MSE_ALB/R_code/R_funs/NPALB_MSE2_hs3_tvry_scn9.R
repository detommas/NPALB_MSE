...
NPALB_MSE2_hs3_tvry_scn9 = function(hsnum,hcrnum,scnnum,itr, rdev1, Bthr, Blim, Tmin, pl) { 
...
B0t = 1:30 # total unfished biomass
B0t_om = 1:30 # total unfished biomass om
...
for (tstep in 1:10){
  ...
  OMBoot_fun_tvry_scn9(pdir, sdir, hs, hcr, scn, hsw, hcrw, scnw, pwin, itr, tstep, tasmt, new_cdat, rec_devs, sel_devs)
  ...
  EM_fun_nohess_scn9(pdir, sdir, hs, hcr, scn, hsw, hcrw, scnw, pwin, itr, tstep)
