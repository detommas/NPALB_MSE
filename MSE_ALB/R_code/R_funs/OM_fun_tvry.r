...
OM_fun_tvry <- function(pdir, sdir, hs, hcr, scn, hsw, hcrw, scnw, pwin, itr, tstep, tasmt, new_cdat, rec_devs, sel_devs){
...
#*****************************CREATE DAT FILE*******************************************   
  ...
  boot_dat=SS_readdat(file = "data.ss_new", version ="3.24",section = 2)
